...
from api.serializers import (
    ...
    ItemsSerializer,
    MessageFilesSerializer,
    MessageImagesSerializer,
    MessageSerializer,
    UserSerializer,
)
...
class UserCreateView(mixins.CreateModelMixin, GenericViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        user = serializer.save(user_type='find_uz_user')
...
class ItemImagesAuthenticatedView(
    mixins.CreateModelMixin, mixins.DestroyModelMixin, mixins.UpdateModelMixin, GenericViewSet,
):
    permission_classes = [IsAuthenticated, IsOwner]
...
class MessageView(mixins.ListModelMixin, GenericViewSet):
    ...
    def get_queryset(self):
        return Message.objects.filter(
            ...
            Prefetch('messageimages', queryset=MessageImage.objects.all()),
